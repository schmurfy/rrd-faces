        ...
        function processData() {
            ...
            for( var i = 0; i < series.length; ++i ) {
                ...
                for( var j = 0; j < data.length; ++j ) {
                    ...
                    if( data[j].base ){ y = y + data[j].base }
        ...
        function drawSeriesBars( series ) {
            function plotBars( data, barWidth, offset, fill ) {
                for( var i = 0; i < data.length; i++ ) {
                    ...
                    var x = data[i].x,
                        y = data[i].y,
                        base = data[i].base, // if there is a base then use it as our zero
                        drawLeft = true,
                        drawTop = true,
                        drawRight = true;
            ...
            var c = parseColor( series.color );
            c.a = series.bars.borderOpacity;
            c.normalize();
        ...
        function setFillStyle( obj, seriesColor ) {
            ...
            if( obj.fill ) {
                if( obj.fillColor ) {
                    ...
                    c.a = typeof obj.fill == 'number' ? obj.fill : ( opacity ? opacity : 0.4 );
                    c.normalize();
